...
class DefaultArtikelIntegrationTest extends AbstractTransactionalJUnit4SpringContextTests {

    private final static String ARTIKELS = "artikels";
    private final DefaultArtikelService service;
    private final EntityManager manager;

    public DefaultArtikelIntegrationTest(DefaultArtikelService service, EntityManager manager) {
    ...
    void verhoogVerkoopPrijs() {
        ...
        manager.flush();
        assertThat(countRowsInTableWhere(ARTIKELS, "verkoopprijs = 30 and id = " + id)) .isOne();
    }
}
